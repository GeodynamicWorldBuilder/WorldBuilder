...
#include "world_builder/features/plume_models/grains/random_uniform_distribution.h"
  ...
  namespace Features
  {
    namespace PlumeModels
    {
      namespace Grains
      {
        ...
        WB_REGISTER_FEATURE_PLUME_GRAINS_MODEL(RandomUniformDistribution, random uniform distribution)
      } // namespace Grains
    } // namespace PlumeModels
  } // namespace Features
} // namespace WorldBuilder

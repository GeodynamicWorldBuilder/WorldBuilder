...
#include "world_builder/features/continental_plate_models/temperature/perlin_noise.h"
    ...
    namespace ContinentalPlateModels
    {
      namespace Temperature
      {
        PerlinNoise::PerlinNoise(WorldBuilder::World *world_)
          ...
          min_depth(NaN::DSNAN),
          max_depth(NaN::DSNAN),
          min_temperature(NaN::DSNAN),
          max_temperature(NaN::DSNAN),
          frequency(1.0),
          octaves(1),
          persistence(0.5),
          lacunarity(2.0),
        ...
        double
        PerlinNoise::get_temperature(const Point<3> &position_in_cartesian_coordinates,
        ...
        WB_REGISTER_FEATURE_CONTINENTAL_PLATE_TEMPERATURE_MODEL(PerlinNoise, perlin_noise)
      } // namespace Temperature
    } // namespace ContinentalPlateModels
  } // namespace Features
} // namespace WorldBuilder

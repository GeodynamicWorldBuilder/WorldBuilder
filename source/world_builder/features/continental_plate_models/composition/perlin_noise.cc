...
#include "world_builder/features/continental_plate_models/composition/perlin_noise.h"
  ...
  namespace Features
  {
    ...
    namespace ContinentalPlateModels
    {
      namespace Composition
      {
        ...
        void
        PerlinNoise::declare_entries(Parameters &prm, const std::string & /*unused*/)
        {
        ...
        double
        PerlinNoise::get_composition(const Point<3> &position_in_cartesian_coordinates,
                  ...
                  for (unsigned int i : compositions)
                    {
                      if (i == composition_number)
                        {
                          const double noise_val = octave_noise(position_in_cartesian_coordinates[0],
        ...
        WB_REGISTER_FEATURE_CONTINENTAL_PLATE_COMPOSITION_MODEL(PerlinNoise, perlin_noise)
      } // namespace Composition
    } // namespace ContinentalPlateModels
  } // namespace Features
} // namespace WorldBuilder

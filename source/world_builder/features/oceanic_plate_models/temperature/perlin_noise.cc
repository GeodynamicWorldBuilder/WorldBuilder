...
#include "world_builder/features/oceanic_plate_models/temperature/perlin_noise.h"
  ...
  namespace Features
  {
    ...
    namespace OceanicPlateModels
    {
      namespace Temperature
      {
        ...
        WB_REGISTER_FEATURE_OCEANIC_PLATE_TEMPERATURE_MODEL(PerlinNoise, perlin_noise)
      }
    }
  }
}

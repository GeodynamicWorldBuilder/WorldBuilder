...
#include "world_builder/features/mantle_layer_models/temperature/perlin_noise.h"
  ...
  namespace Features
  {
    ...
    namespace MantleLayerModels
    {
      namespace Temperature
      {
        ...
        WB_REGISTER_FEATURE_MANTLE_LAYER_TEMPERATURE_MODEL(PerlinNoise, perlin_noise)
      }
    }
  }
}

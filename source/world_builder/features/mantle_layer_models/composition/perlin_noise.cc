...
#include "world_builder/features/mantle_layer_models/composition/perlin_noise.h"
  ...
  namespace Features
  {
    ...
    namespace MantleLayerModels
    {
      namespace Composition
      {
        ...
        WB_REGISTER_FEATURE_MANTLE_LAYER_COMPOSITION_MODEL(PerlinNoise, perlin_noise)
      }
    }
  }
}

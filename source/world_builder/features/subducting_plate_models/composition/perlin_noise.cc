...
#include "world_builder/features/subducting_plate_models/composition/perlin_noise.h"
  ...
  namespace Features
  {
    ...
    namespace SubductingPlateModels
    {
      namespace Composition
      {
        ...
        WB_REGISTER_FEATURE_SUBDUCTING_PLATE_COMPOSITION_MODEL(PerlinNoise, perlin_noise)
      }
    }
  }
}

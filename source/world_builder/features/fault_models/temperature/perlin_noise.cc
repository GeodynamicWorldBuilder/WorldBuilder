...
#include "world_builder/features/fault_models/temperature/perlin_noise.h"
  ...
  namespace Features
  {
    ...
    namespace FaultModels
    {
      namespace Temperature
      {
        ...
        {
          if (std::fabs(distance_from_plane.distance_from_plane) <= max_distance &&
              std::fabs(distance_from_plane.distance_from_plane) >= min_distance)
            {
        ...
        WB_REGISTER_FEATURE_FAULT_TEMPERATURE_MODEL(PerlinNoise, perlin_noise)
      }
    }
  }
}

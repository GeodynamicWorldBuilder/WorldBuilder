...
namespace WorldBuilder
{
  ...
  namespace Objects
  {
    ...
    Contour<A,B,C,D>::Contour(const double default_depth_,
    ...
    template<class A, class B, class C, class D>
    Contour<A,B,C,D>::Contour(Contour const &other)
      :
      value_depth(other.value_depth),
    ...
    */
    template class
    Contour<Features::SubductingPlateModels::Temperature::Interface,Features::SubductingPlateModels::Composition::Interface,Features::SubductingPlateModels::Grains::Interface,Features::SubductingPlateModels::Velocity::Interface>;
    ...
    */
    template class
    Contour<Features::FaultModels::Temperature::Interface,Features::FaultModels::Composition::Interface,Features::FaultModels::Grains::Interface,Features::FaultModels::Velocity::Interface>;

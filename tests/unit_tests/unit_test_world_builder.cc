...
TEST_CASE("WorldBuilder Utilities function: distance_point_from_curved_planes cartesian part 1")
{
  ...
  CHECK(distance_from_planes.distance_from_plane == std::numeric_limits<double>::infinity());
  CHECK(distance_from_planes.distance_along_plane == std::numeric_limits<double>::infinity());

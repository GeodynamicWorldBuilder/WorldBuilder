...
extern "C" {
   ...
   */
  void create_world(void **ptr_ptr_world, const char *world_builder_file, bool *has_output_dir = NULL, const char *output_dir = NULL, const double random_number_seed = 1.0);

...
#ifndef _world_builder_features_subducting_plate_lattice_properties_interface_h
#define _world_builder_features_subducting_plate_lattice_properties_interface_h
  ...
  namespace Features
  {
    ...
    namespace SubductingPlateModels
    {
      namespace LatticeProperties
      {
         ...
         */
#define WB_REGISTER_FEATURE_CONTINENTAL_LATTICE_PROPERTIES_MODEL(klass,name) \

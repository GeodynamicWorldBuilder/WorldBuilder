    ...
    class SubductingPlate : public Interface
    {
      ...
      private:
        ...
        std::vector<Objects::Segment<Features::SubductingPlateModels::Temperature::Interface,
            ...
            Features::SubductingPlateModels::LatticeProperties::Interface> > default_segment_vector;

        std::vector< std::vector<Objects::Segment<Features::SubductingPlateModels::Temperature::Interface,
            Features::SubductingPlateModels::Composition::Interface,
            Features::SubductingPlateModels::LatticeProperties::Interface> > > sections_segment_vector;
        ...
        std::vector<std::vector<Objects::Segment<Features::SubductingPlateModels::Temperature::Interface,
            Features::SubductingPlateModels::Composition::Interface,
            Features::SubductingPlateModels::LatticeProperties::Interface> > > segment_vector;

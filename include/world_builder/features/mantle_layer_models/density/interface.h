...
#ifndef WORLD_BUILDER_FEATURES_MANTLE_LAYER_MODELS_DENSITY_INTERFACE_H
#define WORLD_BUILDER_FEATURES_MANTLE_LAYER_MODELS_DENSITY_INTERFACE_H
  ...
  namespace Features
  {
    ...
    namespace MantleLayerModels
    {
      namespace Density
      {
         ...
         */
#define WB_REGISTER_FEATURE_MANTLE_LAYER_DENSITY_MODEL(klass,name) \

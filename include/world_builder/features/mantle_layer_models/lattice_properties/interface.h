...
#ifndef _world_builder_features_mantle_layer_lattice_properties_interface_h
#define _world_builder_features_mantle_layer_lattice_properties_interface_h
  ...
  namespace Features
  {
    ...
    namespace MantleLayerModels
    {
      namespace LatticeProperties
      {
         ...
         */
#define WB_REGISTER_FEATURE_MANTLE_LAYER_LATTICE_PROPERTIES_MODEL(klass,name) \

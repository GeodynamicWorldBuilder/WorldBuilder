...
#ifndef _world_builder_features_mantle_layer_composition_layers_h
#define _world_builder_features_mantle_layer_composition_layers_h
  ...
  namespace Features
  {
    namespace MantleLayerModels
    {
      namespace Composition
      {
         ...
         */
        WB_REGISTER_FEATURE_MANTLE_LAYER_COMPOSITION_MODEL_HEADER(Layers)

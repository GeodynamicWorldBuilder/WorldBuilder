...
#ifndef _world_builder_features_mantle_layer_temperature_layers_h
#define _world_builder_features_mantle_layer_temperature_layers_h
  ...
  namespace Features
  {
    namespace MantleLayerModels
    {
      namespace Temperature
      {
         ...
         */
        WB_REGISTER_FEATURE_MANTLE_LAYER_TEMPERATURE_MODEL_HEADER(Layers)

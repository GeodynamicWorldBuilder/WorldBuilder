...
#ifndef WORLD_BUILDER_FEATURES_PLUME_MODELS_DENSITY_INTERFACE_H
#define WORLD_BUILDER_FEATURES_PLUME_MODELS_DENSITY_INTERFACE_H
  ...
  namespace Features
  {
    ...
    namespace PlumeModels
    {
      namespace Density
      {
         ...
         */
#define WB_REGISTER_FEATURE_PLUME_DENSITY_MODEL(klass,name) \

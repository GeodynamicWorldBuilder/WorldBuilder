...
#ifndef WORLD_BUILDER_FEATURES_CONTINENTAL_PLATE_MODELS_TEMPERATURE_PERLIN_NOISE_H
#define WORLD_BUILDER_FEATURES_CONTINENTAL_PLATE_MODELS_TEMPERATURE_PERLIN_NOISE_H
...
namespace WorldBuilder
{
  ...
  namespace Features
  {
    ...
    namespace ContinentalPlateModels
    {
      ...
      {
        /**
         * Perlin noise based temperature model for continental plates.
         */
        class PerlinNoise final: public Interface
        {
          ...
          private:
            // Perlin noise temperature submodule parameters
            double min_depth;

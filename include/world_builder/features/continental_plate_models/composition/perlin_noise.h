...
#ifndef WORLD_BUILDER_FEATURES_CONTINENTAL_PLATE_MODELS_COMPOSITION_PERLIN_NOISE_H
#define WORLD_BUILDER_FEATURES_CONTINENTAL_PLATE_MODELS_COMPOSITION_PERLIN_NOISE_H
  ...
  namespace Features
  {
    ...
    namespace ContinentalPlateModels
    {
      namespace Composition
      {
         ...
         * for composition. These submodules determine what
         * the returned composition of the composition
        ...
        class PerlinNoise final : public Interface
        {
          ...
          private:
            // PerlinNoise composition submodule parameters

...
#ifndef _world_builder_features_continental_plate_composition_layers_h
#define _world_builder_features_continental_plate_composition_layers_h
  ...
  namespace Features
  {
    namespace ContinentalPlateModels
    {
      namespace Composition
      {
         ...
         */
        WB_REGISTER_FEATURE_CONTINENTAL_COMPOSITION_MODEL_HEADER(Layers)

...
#ifndef _world_builder_features_continental_plate_lattice_properties_interface_h
#define _world_builder_features_continental_plate_lattice_properties_interface_h
      ...
      namespace LatticeProperties
      {
        ...
        class Interface
        {
          public:
            ...
            /**
             * takes composition and position and returns lattice properties.
             */
            virtual
            std::pair<std::vector<std::array<double,9> >, std::vector<double> >
            get_lattice_properties(const Point<3> &position,
                                   const double depth,
                                   const unsigned int composition_number,
                                   std::pair<std::vector<std::array<double,9> >, std::vector<double> > lattice_properties,
         ...
         */
#define WB_REGISTER_FEATURE_CONTINENTAL_PLATE_LATTICE_PROPERTIES_MODEL(klass,name) \

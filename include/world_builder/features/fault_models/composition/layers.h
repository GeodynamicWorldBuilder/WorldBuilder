...
#ifndef _world_builder_features_fault_composition_layers_h
#define _world_builder_features_fault_composition_layers_h
  ...
  namespace Features
  {
    namespace FaultModels
    {
      namespace Composition
      {
         ...
         */
        WB_REGISTER_FEATURE_FAULT_COMPOSITION_MODEL_HEADER(Layers)

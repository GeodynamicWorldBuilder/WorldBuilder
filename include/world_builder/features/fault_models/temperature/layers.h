...
#ifndef _world_builder_features_fault_temperature_layers_h
#define _world_builder_features_fault_temperature_layers_h
  ...
  namespace Features
  {
    namespace FaultModels
    {
      namespace Temperature
      {
         ...
         */
        WB_REGISTER_FEATURE_FAULT_TEMPERATURE_MODEL_HEADER(Layers)

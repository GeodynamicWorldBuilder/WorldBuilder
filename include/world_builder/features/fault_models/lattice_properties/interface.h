...
#ifndef _world_builder_features_fault_lattice_properties_interface_h
#define _world_builder_features_fault_lattice_properties_interface_h
  ...
  namespace Features
  {
    ...
    namespace FaultModels
    {
      namespace LatticeProperties
      {
         ...
         */
#define WB_REGISTER_FEATURE_FAULT_LATTICE_PROPERTIES_MODEL(klass,name) \

...
#ifndef WORLD_BUILDER_FEATURES_OCEANIC_PLATE_MODELS_DENSITY_INTERFACE_H
#define WORLD_BUILDER_FEATURES_OCEANIC_PLATE_MODELS_DENSITY_INTERFACE_H
  ...
  namespace Features
  {
    ...
    namespace OceanicPlateModels
    {
      namespace Density
      {
         ...
         */
#define WB_REGISTER_FEATURE_OCEANIC_PLATE_DENSITY_MODEL(klass,name) \

...
namespace WorldBuilder
{
  ...
  namespace Types
  {
    ...
    enum class type
    {
      None,Bool,String,Double,Int,UnsignedInt,Array,Object,List,Point2D,Point3D,CoordinateSystem,PluginSystem,Segment,ConstantLayer,ValueAtPoints,Contour,OneOf
    };

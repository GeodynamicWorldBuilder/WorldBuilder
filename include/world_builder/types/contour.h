...
#ifndef WORLD_BUILDER_TYPES_CONTOUR_H
#define WORLD_BUILDER_TYPES_CONTOUR_H
...
namespace WorldBuilder
{
  ...
  namespace Types
  {
     ...
     */
    class Contour : public Interface
    {
      public:
        /**
         * A constructor
         */
        Contour(const double default_length,
      ...
      protected:
        Contour *clone_impl() const override final
        {

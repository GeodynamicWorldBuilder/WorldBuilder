...
\begin{itemize}[leftmargin=0em]\item {\bf type}: object
\item {\bf description}: Half space cooled topography
\item {\bf additionalProperties}: false
\item {\bf required}: [model, ridge coordinates, spreading velocity, max depth, min ocean depth, bottom density, top density]\end{itemize}
...
\item {\bf type}: string
\item {\bf description}: The name of the topography model.
\item {\bf enum}: [half space cooling]\end{itemize}\section{(1) /oneOf/oneOf/oneOf/oneOf/oneOf/oneOf/min depth/oneOf/items/oneOf/min depth/oneOf/min depth/oneOf/items/oneOf/items/oneOf/min depth/oneOf/min depth/oneOf/min depth/oneOf/min depth/oneOf/oneOf/oneOf/oneOf/oneOf/oneOf/oneOf/oneOf/oneOf/oneOf/oneOf/oneOf/operation}
\begin{itemize}[leftmargin=1em]\item {\bf default value}: replace
\item {\bf type}: string
\item {\bf description}: Whether the value should replace any value previously defined at this location (replace), add the value to the previously define value (add) or subtract the value to the previously define value (subtract).

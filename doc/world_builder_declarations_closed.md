...
- **type**:object
- **description**:Half space cooled topography
- **additionalProperties**:false
- **required**:[model, ridge coordinates, spreading velocity, max depth, min ocean depth, bottom density, top density]
